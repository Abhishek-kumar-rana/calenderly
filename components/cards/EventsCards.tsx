...
type EventCardProps = {
  ...
  export default function EventCard ({
    ...
    return (
        <Card className={cn("flex flex-col border-4 rounded-2xl border-blue-500/20 shadow-2xl transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110", !isActive && " bg-accent border-none border-accent")}>
